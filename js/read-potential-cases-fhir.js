...
(async () => {
  ...
  await fs.writeFile("weight-loss-elixhauser-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("weight-loss-elixhauser-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
